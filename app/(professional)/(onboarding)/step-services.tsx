...
import { ArrowLeft, Briefcase, MapPin } from "lucide-react-native";
...
export default function StepServices() {
  ...
  const handleNext = async () => {
    if (selectedServices.length === 0 || !location.trim()) {
      return Alert.alert(
        "Required",
        "Please select at least one service and enter your area.",
      );
    }
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity
          style={[
            styles.mainButton,
            (selectedServices.length === 0 || !location) && styles.disabledBtn,
          ]}
          onPress={handleNext}
