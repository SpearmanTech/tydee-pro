  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (!permission.granted) {
        Alert.alert(
          "Permission required",
          "Camera access is required to upload documents.",
        );
        return;
      }
      ...
      >
        ...
        <View style={styles.warningBox}>
          ...
          <Text style={styles.warningText}>
            You can browse the marketplace now, but you{" "}
            <Text style={styles.boldText}>cannot accept jobs</Text> until your
            Police Clearance is approved by our team.
          </Text>
        </View>
        ...
        <View style={styles.benefitInfo}>
          ...
          <Text style={styles.benefitSub}>
            • Unlock high-value commercial jobs{"\n"}• Build instant trust with
            homeowners{"\n"}• Featured "Safety First" profile badge
          </Text>
        </View>
