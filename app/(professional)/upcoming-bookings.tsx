          ...
          ListEmptyComponent={
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptySub}>
                No upcoming assignments. Check the Marketplace to bid on new
                jobs.
              </Text>
            </View>
          }
            ...
            <View style={styles.drawerHeader}>
              ...
              <View>
                ...
                <Text style={styles.drawerSub}>
                  Start process before deadline
                </Text>
              </View>
            </View>

            <View style={styles.drawerBody}>
              <Text style={styles.drawerService}>
                {selectedBooking?.service}
              </Text>
              <Text style={styles.drawerWarning}>
                This job must be started within{" "}
                <Text style={styles.bold}>
                  {getTimeLeft(
                    selectedBooking?.bidAcceptedAt,
                    selectedBooking?.urgency || "standard",
                  )}{" "}
                  hours
                </Text>{" "}
                or it will be returned to the open marketplace.
              </Text>
            </View>
